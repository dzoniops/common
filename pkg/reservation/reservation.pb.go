...
type ActiveReservationsGuestResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ActiveReservationsGuestResponse) Reset() {
	*x = ActiveReservationsGuestResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ActiveReservationsGuestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActiveReservationsGuestResponse) ProtoMessage() {}

func (x *ActiveReservationsGuestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_reservation_reservation_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActiveReservationsGuestResponse.ProtoReflect.Descriptor instead.
func (*ActiveReservationsGuestResponse) Descriptor() ([]byte, []int) {
	return file_pkg_reservation_reservation_proto_rawDescGZIP(), []int{2}
}

func (x *ActiveReservationsGuestResponse) GetReservations() []*Reservation {
	if x != nil {
...
var file_pkg_reservation_reservation_proto_rawDesc = []byte{
	...
	0x1f, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69,
	...
	0x52, 0x0c, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2a, 0x98,
	...
	0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1d, 0x0a, 0x19, 0x52, 0x45, 0x53, 0x45,
	0x52, 0x56, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x41,
	0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x01, 0x12, 0x1f, 0x0a, 0x1b, 0x52, 0x45, 0x53, 0x45, 0x52,
	...
	0x45, 0x43, 0x4c, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x03, 0x32, 0x79, 0x0a, 0x12, 0x52, 0x65, 0x73,
	0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x63, 0x0a, 0x19, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x65, 0x72,
	0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x47, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x2e, 0x72,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x47, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x64, 0x7a, 0x6f, 0x6e, 0x69, 0x6f, 0x70, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72,
	0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61,
...
var file_pkg_reservation_reservation_proto_goTypes = []interface{}{
	...
	(*ActiveReservationsGuestResponse)(nil), // 3: reservation.ActiveReservationsGuestResponse
...
var file_pkg_reservation_reservation_proto_depIdxs = []int32{
	...
	2, // 3: reservation.ActiveReservationsGuestResponse.reservations:type_name -> reservation.Reservation
	1, // 4: reservation.ReservationService.ActivateReservationsGuest:input_type -> reservation.IdRequest
	3, // 5: reservation.ReservationService.ActivateReservationsGuest:output_type -> reservation.ActiveReservationsGuestResponse
...
func file_pkg_reservation_reservation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_reservation_reservation_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActiveReservationsGuestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
