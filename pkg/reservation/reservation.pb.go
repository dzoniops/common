...
var file_pkg_reservation_reservation_proto_rawDesc = []byte{
	...
	0x53, 0x5f, 0x44, 0x45, 0x43, 0x4c, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x03, 0x32, 0xe3, 0x03, 0x0a,
...
var file_pkg_reservation_reservation_proto_depIdxs = []int32{
	...
	4,  // 6: reservation.ReservationService.DeleteReservation:input_type -> reservation.IdRequest
	4,  // 7: reservation.ReservationService.Accept:input_type -> reservation.IdRequest
	4,  // 8: reservation.ReservationService.Decline:input_type -> reservation.IdRequest
	4,  // 9: reservation.ReservationService.ActiveReservationsGuest:input_type -> reservation.IdRequest
	4,  // 10: reservation.ReservationService.ActiveReservationsHost:input_type -> reservation.IdRequest
	3,  // 11: reservation.ReservationService.Reserve:output_type -> reservation.ReserveResponse
	7,  // 12: reservation.ReservationService.DeleteReservation:output_type -> google.protobuf.Empty
	3,  // 13: reservation.ReservationService.Accept:output_type -> reservation.ReserveResponse
	3,  // 14: reservation.ReservationService.Decline:output_type -> reservation.ReserveResponse
	5,  // 15: reservation.ReservationService.ActiveReservationsGuest:output_type -> reservation.ActiveReservationsResponse
	5,  // 16: reservation.ReservationService.ActiveReservationsHost:output_type -> reservation.ActiveReservationsResponse
